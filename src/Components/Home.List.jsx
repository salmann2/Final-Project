function HomeList () {
    return (
       ...
       <div className="flex justify-around px-7 py-20">
        ...
        <button className="w-[100px] h-[40px] hover:bg-[#05c3de] rounded-[20px] text-l shadow-lg mt-15 border-1 border-[#ff7b00]">Menu</button>
        <button className="w-[120px] h-[40px] rounded-[20px] text-l shadow-lg bg-[#ff7b00] text-white ml-3">Book a Table</button>
